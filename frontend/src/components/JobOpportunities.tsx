...
import { Briefcase, MapPin, DollarSign, Users, ArrowRight, Star } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-2xl mx-auto">
            Discover career opportunities posted by our alumni network.
          </p>
        </div>

        {jobs.length === 0 ? (
          <p className="text-center text-gray-500 text-lg">
            No job opportunities available right now. Please check back later.
          </p>
        ) : (
          <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
            {jobs.map((job) => (
              <div
                key={job._id}
                className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-100 hover:border-green-200"
              >
                <div className="p-6">
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="bg-white text-green-600 border-2 border-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-600 hover:text-white transition-all duration-200"
          >
            View All Jobs
          </button>
        </div>
